    ...
    <AppShell>
      <main className="editor-layout">
        <section className="editor-main">
          ...
          <form className="panel editor-form" action={updateLyricAction}>
          ...
          <form id="delete-lyric-form" action={deleteLyricAction}>
            <input name="id" type="hidden" value={lyric.id} />
          </form>
        </section>

        <aside className="editor-sidebar">
          <form className="panel" action={updateLyricAction}>
            <input name="id" type="hidden" value={lyric.id} />
          ...
          <form className="panel" action={saveRhymeNoteAction} id="rhyme-panel">
            <input name="lyricId" type="hidden" value={lyric.id} />
            <input name="noteId" type="hidden" value={selectedRhymeNote?.id ?? ""} />
            <div className="section-row">
              ...
              {selectedRhymeNote ? (
                <Link className="ghost-button" href={`/lyrics/${lyric.id}#rhyme-panel`}>
              ...
              lyric.rhymeNotes.map((rhymeNote) => (
                <article className="rhyme-item" key={rhymeNote.id}>
                  ...
                  <div className="rhyme-actions">
                    ...
                    <form action={deleteRhymeNoteAction}>
                      <input name="lyricId" type="hidden" value={lyric.id} />
